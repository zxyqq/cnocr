...
|----------------------------------------------------------------------------------------------------------| ------------ | --------- | -------- | ------------ | ------ | ----------------------- |
| **number-densenet_lite_136-fc** 🆕                                                                       | √   | √  | 680 K | 2.7 M | - | - |
| **number-densenet_lite_136-gru**  🆕 <br /> ([星球会员](https://t.zsxq.com/FEYZRJQ)专享)                       | √  | √ | 1.4 M | 5.5 M | - | - |
| **number-densenet_lite_666-gru_large** 🆕 <br />（[购买链接](https://gf.bilibili.com/item/detail/1104055055)） | √  | √ | 14.5 M | 56 M | - | - |
