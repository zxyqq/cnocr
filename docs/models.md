...
| ----------------------- | ------------ | --------- | -------- | ------------ | ------ | ----------------------- |
| **number-densenet_lite_136-fc** 🆕  | √   | √  | -  | 2.7 M | - | - |
| **number-densenet_lite_136-gru**  🆕 <br /> ([星球会员](https://t.zsxq.com/FEYZRJQ)专享) | √  | √ | - | 5.5 M | - | - |
| **number-densenet_lite_666-gru_large** 🆕 <br />（Coming Soon） | √  | √ | - | 56 M | - | - |
